...
class Settings(BaseSettings):
    ...
    access_token_expire_minutes: int = 5256000  # 10 años (prácticamente infinito)
    refresh_token_expire_days: int = 3650       # 10 años
    remember_me_expire_days: int = 3650         # 10 años
    trusted_device_expire_days: int = 3650      # 10 años
    ...
    ollama_model: str = "gemma:2b"  # Modelo local (gratis)
    openrouter_api_key: str = ""    # https://openrouter.ai
    openrouter_model: str = "nvidia/nemotron-3-super-120b-a12b:free"  # Modelo gratuito activo
