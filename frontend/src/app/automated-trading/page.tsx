...
export default function AutomatedTradingPage() {
  ...
  useEffect(() => {
    ...
    fetchPerformance(); // Cargar performance inicial
  ...
  const fetchPerformance = async (silent: boolean = false) => {
    if (!silent) setLoadingPerf(true);
    try {
      ...
      if (!silent) setLoadingPerf(false);
    }
  };
      ...
      <div className="space-y-6">
        ...
        <Tabs defaultValue="control" className="space-y-4">
          <TabsList className="bg-gray-800 border-gray-700 flex flex-wrap gap-1">
            ...
            <TabsTrigger value="performance" onClick={() => fetchPerformance(false)} className="text-white flex items-center gap-1.5">
